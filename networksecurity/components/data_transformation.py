...
class DataTransformation:
    ...
    def get_data_tranformer_object(cls) -> Pipeline:
        """
        It initiates the KNN imputer object with the parameters specified in training_pipeline.py file
        and return pipeline object with the KNN imputer object as the first step.
        """
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        logging.info("Entered the initiate data transformation method")
        try:
